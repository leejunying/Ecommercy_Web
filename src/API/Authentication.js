  ...
  try {
    ...
    if (checkuser === false) {
      ...
      if (User == true) {
        ...
        transporter.verify(function (error, success) {
          ...
          if (error) {
            ...
            var mail = {
              ...
              subject:
                "WelCome new customer created account from my-Ecommerce website", // Tiêu đề mail
        ...
        res.send({
          status: true,
          message: "Your email has been created successfully",
        });
      }
    } else {
