...
const Products = (props) => {
  ...
  const handleChange = (event, value) => {
    ...
    if (search != "") Get_filter_products(search, value);
    else Get_products(value);
  };
  ...
  const Get_query = () => {
    ...
    if (Color.length == 0) Colorquery = " ";

    if (selectedPrice != "") var Pricequery = "Price=" + selectedPrice;
    else Pricequery = " ";
    if (selectedBrand != "") var Brandquery = "Brand=" + selectedBrand;
    else Brandquery = " ";
        ...
        <Grid conatiner md={12} className="flex Product-container">
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={Adi}
                          onChange={(event) =>
                            handleChange_Brand(event, "Adidas")
                          }
                          name="Adi"
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={Conver}
                          onChange={(event) =>
                            handleChange_Brand(event, "Converse")
                          }
                          name="Conver"
                        />
                      }
          ...
          >
            <Grid>
              <Grid
                container={true}
                className=" flex  jus-start Product_container"
              >
